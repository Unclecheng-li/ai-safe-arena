// AI-SAFE Arena 平面线性图标库（Lucide/Feather 风格，24x24 描边，零依赖零 CDN）
// 用法一（静态 HTML）：<span data-icon="shield"></span> → hydrateIcons() 自动替换为 SVG
// 用法二（JS 拼模板）：import { icon } from './icons.mjs'; icon('trophy', 14)
...
const ICONS = {
  ...
  radar: '<path d="M19.07 4.93A10 10 0 0 0 6.99 3.34"/><path d="M4 6h.01"/><path d="M2.29 9.62a10 10 0 1 0 19.02-1.27"/><path d="M16.24 7.76a6 6 0 1 0-8.01 8.91"/><path d="M12 18h.01"/><path d="M17.99 11.66a6 6 0 0 1-2.22 5.01"/>',
